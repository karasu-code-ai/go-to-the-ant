...
> **Branch `lang/java` — the Java edition** (the classical JVM agent-based-modeling lineage). This branch adds a faithful, dependency-free Java port
> of all six swarms in [`java/`](./java/), beside the pure-Python originals it mirrors. Each language lives on its own
