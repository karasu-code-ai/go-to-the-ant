...
> **Branch `lang/rust` — the Rust edition** (ownership — who is allowed to mutate the shared field). This branch adds a faithful, dependency-free Rust port
> of all six swarms in [`rust/`](./rust/), beside the pure-Python originals it mirrors. Each language lives on its own
